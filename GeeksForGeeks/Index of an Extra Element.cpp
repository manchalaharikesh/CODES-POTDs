...
//              If we further able to repeat above step ans will be similarly updated until we reach the point where the new element has been intserted (i.e., until the point k where to the left every arr1[i] == arr2[i]).
