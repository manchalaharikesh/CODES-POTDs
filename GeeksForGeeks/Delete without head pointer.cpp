// DATE: 16-MAR-2024
// Question URL: https://www.geeksforgeeks.org/problems/delete-without-head-pointer/1

// Question: Delete without head pointer
// Description: You are given a node del_node of a Singly Linked List where you have to delete a value of the given node from the linked list but you are not given the head of the list.
